...
//            {/* contact form */}
//           <div
//             className="bg-white dark:bg-black rounded-lg shadow-lg p-6 col-szan-1 sm:col-span-2 lg:col-span-2 space-y-4">
...
export function Contact() {
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_km4fukj", // Your EmailJS service ID
        "template_tic0uzs", // Your EmailJS template ID
        e.target, // The form element
        "ytz2JCdKedEdCiXoq" // Your EmailJS public key
      )
      .then((response) => {
    ...
    >
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-700 dark:text-gray-400 sm:mt-4">
        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-x-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-gray-700 dark:text-gray-400">
                  bosundecor5@gmail.com
                </span>
              </div>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 col-span-1 sm:col-span-2 lg:col-span-2 space-y-4">
            ...
            <form className="space-y-4" onSubmit={sendEmail}>
              <div>
                ...
                <Input
                  id="email"
                  name="email_from" // Matches the EmailJS template variable
